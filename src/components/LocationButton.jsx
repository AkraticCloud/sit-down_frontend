...
export default function LocationButton({ onResults }) {
...
navigator.geolocation.getCurrentPosition(
  async (position) => {
    ...
    try {
      ...
      const res = await fetch("/places/nearby", {
        method: "POST",
...
return ( <button onClick={handleGetLocation} disabled={loading}>
{loading ? "Finding nearby restaurants..." : "Use My Location"} </button>
);
}
